...
| S8 | Evidence ledger, exclusions, round summary, cross-round memory, residual outcomes, review feedback and project research portfolio | `ledger/<target>/…`, `state/<target>/research-memory.json`, `state/<target>/review-feedback.json`, `state/<target>/research-portfolio.json`, `S8/research-memory.json`, `S8/review-feedback.json`, `S8/research-portfolio.json` | final consistency checks |
