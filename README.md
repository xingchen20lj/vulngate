...
| S2 | Candidate matrix, falsifiable research plans, and cross-artifact research strategy: surface × entry × input × mechanism | `S2/candidate-matrix.json`, `S2/experiment-plans.json`, `S2/research-strategy.json` | — |
