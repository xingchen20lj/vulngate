...
| S8 | Evidence ledger, exclusions, round summary, cross-round memory, residual outcomes, strategy observation feedback, review feedback and project research portfolio | `ledger/<target>/…`, `state/<target>/research-memory.json`, `state/<target>/coverage/research-strategy.json`, `state/<target>/research-portfolio.json`, `S8/research-memory.json`, `S8/research-strategy-feedback.json`, `S8/review-feedback.json`, `S8/research-portfolio.json` | final consistency checks |
