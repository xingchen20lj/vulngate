...
- **Project research portfolio** — S8 composes memory, review feedback, and benchmark context into bounded `research-portfolio-v1` coverage by surface, attack class, variant, and precondition; it emits prioritized `next_probes` and gives only exact matches a tiny scheduler nudge without turning portfolio state into a finding.
